    ...
    useEffect(() => {
        if (
            ...
            if (!myUser || !otherUser) {
                ...
                return; // Exit if users are not available
            }
            ...
            const message: MessageType = {
                ...
                sent_to: isSentByCurrentUser ? (otherUser as UserType) : (myUser as UserType), // Type assertion
                created_by: isSentByCurrentUser ? (myUser as UserType) : (otherUser as UserType), // Type assertion
