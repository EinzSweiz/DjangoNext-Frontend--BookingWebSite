...
const ReservationSidebar: React.FC<ReservationSidebarProps> = ({
    ...
    return (
        <aside className="mt-6 p-6 col-span-2 rounded-xl border border-gray-300 shadow-xl">
            ...
            <div onClick={performBooking} 
            className="cursor-pointer w-full mb-6 py-2 text-center text-white bg-airbnb rounded-xl hover:bg-airbnb-dark transparent">
                Book
            </div>
        </aside>
    )
