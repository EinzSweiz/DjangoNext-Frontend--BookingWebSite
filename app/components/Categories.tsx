            ...
            <div className="flex flex-col items-center w-full">
                ...
                >
                    {isOpen ? (
                        <AiOutlineUp
                            size={18}
                            className="text-black dark:text-white transition-all duration-300 hover:text-green-500"
                        />
                    ) : (
                        <AiOutlineDown
                            size={18}
                ...
                {isOpen ? (
                    <div
                        className="pt-3 pb-6 flex flex-wrap items-center justify-center gap-4 bg-white p-4 rounded-lg shadow-lg transition-all duration-500 dark:bg-gray-800"
                    >
                        {categories.map((category) => (
                            <div
                                ...
                                className={`pb-4 flex flex-col items-center space-y-2 border-b-2 
                                    ...
                                    hover:border-green-500 hover:opacity-100 cursor-pointer transition-all duration-300
                                    w-1/3 sm:w-auto`}
                            >
                                <Image
                                    ...
                                    width={30}
                                    height={30}
                                    className="filter transition-transform duration-300 dark:invert dark:brightness-50 hover:scale-105"
                                />
                    ...
                    <div className="pt-1 pb-1">
                        <svg
                            ...
                            viewBox="0 0 512 512"
                            className="h-5 w-5 text-black dark:text-white hover:text-green-500 transition-colors duration-300"
                        >
