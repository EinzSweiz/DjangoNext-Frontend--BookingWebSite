...
const UserNav: React.FC<UserNavProps> = ({ userId }) => {
  ...
  // NEW: unreadCount will store how many unread conversations we have
  ...
  return (
    <div className="p-2 relative inline-block border rounded-full dark:bg-gray-800 dark:border-gray-700">
      ...
      {isOpen && (
        <div
          className="w-[220px] absolute top-[40px] right-0 bg-white border rounded-xl shadow-md flex flex-col cursor-pointer dark:bg-gray-800 dark:border-gray-700"
          ref={dropdownRef}
        >
          {userId ? (
            <>
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/external-flat-circle-design-circle/32/external-Profile-Avatar-web-and-networking-flat-circle-design-circle.png"
                    alt="Profile"
                  />
                }
                onClick={() => {
              ...
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/color/48/why-us-male--v1.png"
                    alt="Inquiries"
                  />
                }
                onClick={() => {
             ...
             <MenuLink
              ...
              icon={
                <img
                  width="32"
                  height="32"
                  src="https://img.icons8.com/fluency/32/download-mail.png"
                  alt="Inbox"
                />
              }
              onClick={() => {
              ...
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/32/external-properties-investing-flaticons-lineal-color-flat-icons.png"
                    alt="Properties"
                  />
                }
                onClick={() => {
              ...
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/stickers/32/reservation-2.png"
                    alt="Reservations"
                  />
                }
                onClick={() => {
              ...
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/cotton/32/phone-bubble--v2.png"
                    alt="Contact"
                  />
                }
                onClick={() => {
              ...
              <LogoutButton
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/arcade/32/exit.png"
                    alt="exit"
                  />
                }
              ...
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/external-kmg-design-outline-color-kmg-design/32/external-login-real-estate-kmg-design-outline-color-kmg-design.png"
                    alt="login"
                  />
                }
                onClick={() => {
              ...
              <MenuLink
                ...
                icon={
                  <img
                    width="32"
                    height="32"
                    src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/32/external-sign-up-web-store-flaticons-lineal-color-flat-icons-3.png"
                    alt="signup"
                  />
                }
                onClick={() => {
